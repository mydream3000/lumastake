...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->decimal('deposited', 18, 2)->default(0);
            $table->unsignedInteger('current_tier')->nullable()->index();
            $table->string('referral_code', 32)->unique()->nullable();
            $table->foreignId('referred_by')->nullable()->constrained('users')->nullOnDelete();
            $table->boolean('active')->default(false);
            $table->foreignId('referral_level_id')->nullable()->constrained('referral_levels')->nullOnDelete();
