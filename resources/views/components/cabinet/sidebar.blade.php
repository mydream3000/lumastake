...
<div class="hidden lg:flex flex-col w-[346px] bg-gradient-to-b from-cabinet-sidebar-start from-[16%] to-cabinet-sidebar-end pr-8" style="min-height: max(100vh, 100%)">
    {{-- Logo --}}
