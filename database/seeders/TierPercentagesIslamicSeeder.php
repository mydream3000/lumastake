...
class TierPercentagesIslamicSeeder extends Seeder
{
    /**
    ...
    {
        DB::table('tier_percentages_islamic')->truncate();
        ...
        $percentages = [];
        foreach ($tiersData as $tierId => $tierPercentages) {
            foreach ($durations as $index => $duration) {
                $percentages[] = [
                    'tier_id' => $tierId,
                    'duration_days' => $duration,
                    'min_percentage' => $tierPercentages[$index][0],
                    'max_percentage' => $tierPercentages[$index][1],
                    'created_at' => now(),
                    'updated_at' => now(),
                ];
            }
        ...
        DB::table('tier_percentages_islamic')->insert($percentages);
    }
}
