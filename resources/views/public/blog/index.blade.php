...
{{--                    <!-- Декоративная картинка -->--}}
            ...
            <div class="grid lg:grid-cols-3 gap-6 mb-10">
                {{-- Core Types --}}
                <div class="bg-gradient-to-b from-[#78A6DB]/80 to-[#E8F1FF] border-10 border-[#F5F5F5] rounded-[23px] p-12 shadow-[0_4px_10px_0_rgba(0,0,0,0.25)] lg:col-span-2">
                ...
                {{-- Advantages --}}
                <div class="bg-white border-10 border-[#F5F5F5] rounded-[23px] p-12 shadow-[0_4px_10px_0_rgba(0,0,0,0.25)]">
