                ...
                <tr>
                    <td style="padding: 0 40px 20px;">
                        ...
                        <div style="background: rgba(66, 153, 225, 0.1); border-left: 3px solid #4299E1; border-radius: 4px; padding: 14px 16px; margin-bottom: 20px;">
                            <p style="color: #000000; font-size: 14px; margin: 0 0 8px; font-weight: 600;">Transaction Details:</p>
                            <p style="color: #000000; font-size: 13px; line-height: 1.5; margin: 0; word-break: break-all;">{{ $comment }}</p>
                        </div>
                        @endif
                        ...
                        <p style="color: #000000; font-size: 15px; line-height: 1.6; margin: 0;">
                            <strong style="color: #000000;">Status:</strong> <span style="color: #48BB78;">Approved &amp; Processed</span>
                        </p>
                    </td>
                </tr>
