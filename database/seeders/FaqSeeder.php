...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $faqs = [
            ...
            ['question' => 'Does Arbitex support multiple networks?', 'answer' => 'No, we only support TRON TRC20 to ensure low fees and fast transactions.'],
            ...
            ['question' => 'Are there any deposit fees?', 'answer' => 'Arbitex does not charge deposit fees.'],
            ...
            ['question' => 'What is staking in Arbitex?', 'answer' => 'It\'s the process of locking your USDT for a fixed period to earn returns through our arbitrage strategies.'],
