...
@section('content')
<div class="space-y-6" x-data="{ showEditModal: false, editingLink: null }">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Social Links</h1>
            <p class="text-gray-600 mt-1">Управление социальными ссылками в футере сайта</p>
        </div>
    </div>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                            Нет социальных ссылок. Запустите seeder для создания записей.
                        </td>
                    </tr>
                @endforelse
            </tbody>
