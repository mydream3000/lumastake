...
<head>
    ...
    <title>Withdrawal Request Created - Arbitex</title>
</head>
                ...
                <tr>
                    <td style="padding: 0 40px 20px;">
                        ...
                        <div style="background: rgba(251, 176, 59, 0.1); border-left: 3px solid #FBB03B; border-radius: 4px; padding: 14px 16px; margin-bottom: 20px;">
                            <p style="color: #ffffff; font-size: 14px; margin: 0 0 4px;">Token:</p>
                            ...
                            <p style="color: #ffffff; font-size: 13px; margin: 0 0 2px;">Network:</p>
                            <p style="color: #cccccc; font-size: 14px; margin: 0 0 12px;">
                            ...
                            <p style="color: #ffffff; font-size: 13px; margin: 0 0 2px;">Wallet Address:</p>
                            <p style="color: #cccccc; font-size: 12px; font-family: monospace; margin: 0; word-break: break-all;">{{ $walletAddress }}</p>
                        </div>
                        ...
                        <p style="color: #cccccc; font-size: 15px; line-height: 1.6; margin: 0;">
                            <strong style="color: #ffffff;">Status:</strong> Pending Approval
                        </p>
                    </td>
                </tr>
