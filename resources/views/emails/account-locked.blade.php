                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #101221; border-radius: 12px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 0 40px 30px;">
                            <table cellpadding="0" cellspacing="0" style="background: rgba(255, 69, 28, 0.1); border-left: 3px solid #FF451C; border-radius: 4px; padding: 20px;">
                                <tr>
                                    <td>
                                        <p style="margin: 0 0 15px; color: #ffffff; font-size: 14px; line-height: 1.6;">
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            ...
                            <table cellpadding="0" cellspacing="0" style="background: rgba(79, 209, 197, 0.1); border: 1px solid rgba(79, 209, 197, 0.3); border-radius: 8px; padding: 20px; width: 100%;">
                                <tr>
                                    <td>
                                        <p style="margin: 0 0 10px; color: #999999; font-size: 13px;">Email Support:</p>
                                        <p style="margin: 0 0 20px; color: #4FD1C5; font-size: 16px; font-weight: 600;">
                                            <a href="mailto:support@lumastake.com" style="color: #4FD1C5; text-decoration: none;">support@lumastake.com</a>
                                        </p>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            <p style="margin: 0 0 15px; color: #ffffff; font-size: 15px; font-weight: 600;">Security Tips:</p>
