                                ...
                                <tr>
                                    <td>
                                        <p style="margin: 0; color: #ffffff; font-size: 14px; line-height: 1.5;">
                                            <strong style="color: #FF451C;">Important:</strong> This code will expire in 15 minutes. If you did not create an account with Lumastake, please ignore this email.
                                        </p>
                                    </td>
                                </tr>
                            </table>
