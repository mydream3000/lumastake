...
<div class="hidden lg:flex flex-col w-[346px] bg-gradient-to-b from-cabinet-sidebar-start to-cabinet-sidebar-end to-[90%] pr-8" style="min-height: max(100vh, 100%)">
    {{-- Logo --}}
