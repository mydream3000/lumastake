<header class="fixed top-0 left-0 right-0 w-full z-40 bg-white/80 backdrop-blur-md border-b border-gray-100" id="header">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="hidden md:flex justify-between items-center py-4">
            ...
            <nav class="flex items-center space-x-8">
                <a href="{{ route('about') }}" class="text-[#262262] font-medium hover:text-indigo-600 transition-colors">About Us</a>
                <a href="{{ route('profit-tiers') }}" class="text-[#262262] font-medium hover:text-indigo-600 transition-colors">Profit Tiers</a>
                <a href="{{ route('blog') }}" class="text-[#262262] font-medium hover:text-indigo-600 transition-colors">Blog</a>
                <a href="{{ route('contact') }}" class="text-[#262262] font-medium hover:text-indigo-600 transition-colors">Contact Us</a>
                <a href="{{ route('faq') }}" class="text-[#262262] font-medium hover:text-indigo-600 transition-colors">FAQ's</a>
            </nav>

            <!-- Desktop Buttons -->
            <div class="flex items-center space-x-4">
                <a href="{{ route('login') }}" class="bg-[#D9FF00] text-[#262262] px-6 py-2 rounded font-bold hover:bg-[#c4e600] transition-colors">Login</a>
                <a href="{{ route('register') }}" class="border border-[#262262] text-[#262262] px-6 py-2 rounded font-medium hover:bg-gray-50 transition-colors">Register</a>
            </div>
        </div>
        ...
        <div class="md:hidden flex justify-between items-center py-4">
            <a class="logo" href="{{ route('home') }}">
                <img src="{{ asset('img/logo.png') }}" alt="LumaStake Logo" class="h-8 w-auto">
            </a>

            <div class="flex items-center space-x-4">
                <button id="mobile-menu-button" class="text-[#262262]">
